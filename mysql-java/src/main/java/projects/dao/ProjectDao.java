...
public class ProjectDao extends DaoBase {
  ...
  public Project insertProject(Project project) {
   ...
   //This method uses JDBC methods to retrieve all project rows from the project table.
  ...
  public Optional<Project> fetchProjectById(Integer projectId) {
   ...
   //This method retrieves all the categories associated with the given project ID.
  private List<Category> fetchCategoriesForProject(Connection conn, Integer projectId) {
   ...
   //This method uses JDBC method calls to retrieve project steps for the given project ID.
  private List<Step> fetchStepsForProject(Connection conn, Integer projectId) throws SQLException {
   ...
   // This method uses JDBC method calls to retrieve project materials for the given project ID.
  private List<Material> fetchMaterialsForProject(Connection conn, Integer projectId)
   ...
   //This method uses JDBC calls to modify the project details.
    ...
    try(Connection conn = DbConnection.getConnection()) {
      ...
      try(PreparedStatement stmt = conn.prepareStatement(sql)) {
        setParameter(stmt, 1, projectId, Integer.class);
         ...
         // If the project ID is correct, the number of rows modified will be 1.
